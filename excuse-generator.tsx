...
const excusasPorNivel = {
  suave: [
    ...
    "Estuve esperando a un cerrajero que se retrasó más de lo normal",
    "Me equivoqué de dirección y llegué al lugar equivocado",
    "Me olvidé las llaves adentro y tuve que esperar que alguien me abra",
    "Pensé que la reunión era virtual y estuve esperando el enlace",
    "Me olvidé la mochila en casa y tuve que volver a buscarla",
    "Me agarró un control policial y me demoraron",
    "Hubo un problema en el edificio con el agua y tuve que quedarme",
    "Me llamó un familiar mayor y no podía cortar",
    "Mi aplicación de calendario no me notificó",
    "Me hackearon el mail y estuve intentando recuperarlo",
    "Me quedé sin saldo en la SUBE y tuve que caminar",
    "Me equivoqué de parada y tuve que volver",
    "Me olvidé el celular en el taxi y fui a buscarlo",
    "Se me rompió la tarjeta del cajero y tuve que hacer todo en efectivo",
  ],
  creativa: [
    ...
    "Mi impresora solo imprime en arameo antiguo y tuve que traducir",
    "Me atrapó un hilo de Reddit y no pude salir a tiempo",
    "Mi aspiradora se rebeló y bloqueó la puerta",
    "Estaba buscando la tecla 'Cualquiera' del teclado",
    "Mi GPS pensó que hoy es feriado y no me marcó la ruta",
    "Estuve resolviendo un cubo Rubik que no es mío",
    "Mi nevera y mi horno se pelearon y tuve que mediar",
    "Estaba practicando para cuando inventen los viajes en el tiempo",
    "Perdí media hora buscando un archivo que no existía",
    "Tuve que consolar a mi cactus, parece que está pasando por algo",
    "Mi gato se sentó arriba del teclado y no me dejó levantarme",
    "Estaba en una intensa discusión con mi espejo sobre autoestima",
    "Mi calendario y yo tuvimos un desacuerdo profundo",
    "Me distraje buscando el origen del queso azul",
    "Mi computadora me dijo que hoy no estaba para trabajar",
    "Me quedé atrapado en el algoritmo de TikTok por accidente",
    "Estaba ayudando a mi cactus a superar su miedo al abandono",
  ...
  caotica: [
    ...
    "Me fusioné accidentalmente con mi sillón y fue difícil separarnos",
    "Un enjambre de abejas bloqueó mi salida y tuvimos que negociar",
    "Me encontré atrapado en un loop temporal de cinco minutos",
    "Mi pez dorado me chantajeó emocionalmente para que no me vaya",
    "Un gnomo cambió la disposición de las calles y me perdí",
    "Estaba enseñándole a un murciélago cómo usar Google Maps",
    "Descubrí que hablo dormido y estaba teniendo una conferencia",
    "Mi lavavajillas se inscribió solo en una maratón de 24 horas",
    "Un mago me convirtió en piedra por error y recién me deshizo el hechizo",
    "Perdí la noción del tiempo intentando entender el horóscopo de Marte",
    "Me absorbió un agujero negro de ansiedad y recién pude salir",
    "Me estaban haciendo un control antidopaje emocional",
    "Mi reflejo decidió que hoy no me representaba",
    "Estuve negociando con una paloma que tomó mi terraza como rehén",
    "Fui confundido con un doble de riesgo y terminé en un comercial de Japón",
    "Mi habitación se declaró independiente y no me dejaba entrar",
    "Estaba discutiendo con Siri sobre cuál es el sentido de la existencia",
    "Fui parte de un torneo clandestino de piedra, papel o tijera",
    "Me quedé atrapado dentro del microondas (larga historia)",
    "Me olvidé que era lunes, pensé que seguíamos en domingo versión beta",
  ],
}
